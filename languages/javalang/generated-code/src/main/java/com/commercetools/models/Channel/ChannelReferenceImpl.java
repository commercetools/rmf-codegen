...
public class ChannelReferenceImpl implements ChannelReference {
   ...
   @JsonCreator
   ChannelReferenceImpl(@JsonProperty("id") final String id, @JsonProperty("key") final String key, @JsonProperty("obj") final com.commercetools.models.Channel.Channel obj) {
      this.id = id;
      this.key = key;
      this.obj = obj;
   }
