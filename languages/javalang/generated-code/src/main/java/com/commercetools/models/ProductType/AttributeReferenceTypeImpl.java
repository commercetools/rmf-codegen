...
public class AttributeReferenceTypeImpl implements AttributeReferenceType {

   private ReferenceTypeId referenceTypeId;

   @JsonCreator
   AttributeReferenceTypeImpl(@JsonProperty("referenceTypeId") final ReferenceTypeId referenceTypeId) {
