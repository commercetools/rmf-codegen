...
public class ReviewRatingStatisticsImpl implements ReviewRatingStatistics {
   ...
   @JsonCreator
   ReviewRatingStatisticsImpl(@JsonProperty("highestRating") final Integer highestRating, @JsonProperty("averageRating") final Integer averageRating, @JsonProperty("count") final Integer count, @JsonProperty("ratingsDistribution") final java.lang.Object ratingsDistribution, @JsonProperty("lowestRating") final Integer lowestRating) {
