...
public interface ProductVariantChannelAvailabilityMap  {
   ...
   public static ProductVariantChannelAvailabilityMapImpl of(String json) {
      try{
          return CommercetoolsJsonUtils.fromJsonString(json, ProductVariantChannelAvailabilityMapImpl.class);
      }catch (IOException e){
          e.printStackTrace();
      }
      return null;
