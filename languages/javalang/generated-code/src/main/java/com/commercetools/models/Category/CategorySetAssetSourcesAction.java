...
public interface CategorySetAssetSourcesAction extends CategoryUpdateAction {
   ...
   public static CategorySetAssetSourcesActionImpl of(String json) {
      try{
          return CommercetoolsJsonUtils.fromJsonString(json, CategorySetAssetSourcesActionImpl.class);
      }catch (IOException e){
          e.printStackTrace();
      }
      return null;
