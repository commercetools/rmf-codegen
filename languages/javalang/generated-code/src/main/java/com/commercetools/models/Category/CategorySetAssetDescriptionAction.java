...
public interface CategorySetAssetDescriptionAction extends CategoryUpdateAction {
   ...
   public static CategorySetAssetDescriptionActionImpl of(String json) {
      try{
          return CommercetoolsJsonUtils.fromJsonString(json, CategorySetAssetDescriptionActionImpl.class);
      }catch (IOException e){
          e.printStackTrace();
      }
      return null;
