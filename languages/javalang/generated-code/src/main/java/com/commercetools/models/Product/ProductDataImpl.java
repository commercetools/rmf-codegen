...
public class ProductDataImpl implements ProductData {
   ...
   @JsonCreator
   ProductDataImpl(@JsonProperty("metaKeywords") final com.commercetools.models.Common.LocalizedString metaKeywords, @JsonProperty("categoryOrderHints") final com.commercetools.models.Product.CategoryOrderHints categoryOrderHints, @JsonProperty("searchKeywords") final com.commercetools.models.Product.SearchKeywords searchKeywords, @JsonProperty("metaTitle") final com.commercetools.models.Common.LocalizedString metaTitle, @JsonProperty("name") final com.commercetools.models.Common.LocalizedString name, @JsonProperty("description") final com.commercetools.models.Common.LocalizedString description, @JsonProperty("variants") final List<ProductVariant> variants, @JsonProperty("masterVariant") final com.commercetools.models.Product.ProductVariant masterVariant, @JsonProperty("categories") final List<CategoryReference> categories, @JsonProperty("metaDescription") final com.commercetools.models.Common.LocalizedString metaDescription, @JsonProperty("slug") final com.commercetools.models.Common.LocalizedString slug) {
