...
public class ScopedPriceImpl implements ScopedPrice {
   ...
   @JsonCreator
   ScopedPriceImpl(@JsonProperty("discounted") final com.commercetools.models.Common.DiscountedPrice discounted, @JsonProperty("country") final String country, @JsonProperty("customerGroup") final com.commercetools.models.CustomerGroup.CustomerGroupReference customerGroup, @JsonProperty("custom") final com.commercetools.models.Type.CustomFields custom, @JsonProperty("channel") final com.commercetools.models.Channel.ChannelReference channel, @JsonProperty("validUntil") final ZonedDateTime validUntil, @JsonProperty("validFrom") final ZonedDateTime validFrom, @JsonProperty("id") final String id, @JsonProperty("value") final com.commercetools.models.Common.TypedMoney value, @JsonProperty("currentValue") final com.commercetools.models.Common.TypedMoney currentValue) {
