...
public interface ProductVariantChannelAvailability  {
   ...
   public static ProductVariantChannelAvailabilityImpl of(String json) {
      try{
          return CommercetoolsJsonUtils.fromJsonString(json, ProductVariantChannelAvailabilityImpl.class);
      }catch (IOException e){
          e.printStackTrace();
      }
      return null;
