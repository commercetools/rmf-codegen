...
public class PriceDraftImpl implements PriceDraft {
   ...
   @JsonCreator
   PriceDraftImpl(@JsonProperty("country") final String country, @JsonProperty("tiers") final List<PriceTier> tiers, @JsonProperty("customerGroup") final com.commercetools.models.CustomerGroup.CustomerGroupReference customerGroup, @JsonProperty("custom") final com.commercetools.models.Type.CustomFieldsDraft custom, @JsonProperty("channel") final com.commercetools.models.Channel.ChannelReference channel, @JsonProperty("validUntil") final ZonedDateTime validUntil, @JsonProperty("validFrom") final ZonedDateTime validFrom, @JsonProperty("value") final com.commercetools.models.Common.Money value) {
