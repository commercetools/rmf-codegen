...
public interface CategoryChangeAssetNameAction extends CategoryUpdateAction {
   ...
   public static CategoryChangeAssetNameActionImpl of(String json) {
      try{
          return CommercetoolsJsonUtils.fromJsonString(json, CategoryChangeAssetNameActionImpl.class);
      }catch (IOException e){
          e.printStackTrace();
      }
      return null;
