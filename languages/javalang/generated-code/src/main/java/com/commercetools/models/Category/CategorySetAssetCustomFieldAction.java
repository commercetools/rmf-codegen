...
import com.commercetools.models.Category.CategorySetAssetCustomFieldActionImpl;
...
public interface CategorySetAssetCustomFieldAction extends CategoryUpdateAction {
   ...
   public static CategorySetAssetCustomFieldActionImpl of(String json) {
      try{
          return CommercetoolsJsonUtils.fromJsonString(json, CategorySetAssetCustomFieldActionImpl.class);
      }catch (IOException e){
          e.printStackTrace();
      }
      return null;
