...
public interface CategorySetMetaKeywordsAction extends CategoryUpdateAction {
   ...
   public static CategorySetMetaKeywordsActionImpl of(String json) {
      try{
          return CommercetoolsJsonUtils.fromJsonString(json, CategorySetMetaKeywordsActionImpl.class);
      }catch (IOException e){
          e.printStackTrace();
      }
      return null;
