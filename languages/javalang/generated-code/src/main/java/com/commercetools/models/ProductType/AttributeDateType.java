...
import com.commercetools.models.ProductType.AttributeDateTypeImpl;
...
public interface AttributeDateType extends AttributeType {
   ...
   public static AttributeDateTypeImpl of(String json) {
      try{
          return CommercetoolsJsonUtils.fromJsonString(json, AttributeDateTypeImpl.class);
      }catch (IOException e){
          e.printStackTrace();
      }
      return null;
