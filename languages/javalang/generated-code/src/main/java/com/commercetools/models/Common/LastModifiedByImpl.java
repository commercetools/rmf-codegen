...
public class LastModifiedByImpl implements LastModifiedBy {
   ...
   @JsonCreator
   LastModifiedByImpl(@JsonProperty("anonymousId") final String anonymousId, @JsonProperty("clientId") final String clientId, @JsonProperty("externalUserId") final String externalUserId, @JsonProperty("customer") final com.commercetools.models.Customer.CustomerReference customer) {
