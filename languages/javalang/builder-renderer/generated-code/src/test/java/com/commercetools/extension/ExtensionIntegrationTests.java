...
public class ExtensionIntegrationTests {
    ...
    public void getById() {
        ExtensionFixtures.withExtension(extension -> {
            Extension queriedExtension = ApiRoot.withProjectKeyValue(CommercetoolsTestUtils.getProjectKey())
                    .extensions()
    ...
    public void query() {
        ExtensionFixtures.withExtension(extension -> {
            ExtensionPagedQueryResponse response = ApiRoot.withProjectKeyValue(CommercetoolsTestUtils.getProjectKey())
                    .extensions()
                    .get()
    ...
    public void updateById() {
        ExtensionFixtures.withUpdateableExtension(extension -> {
            ...
            Extension updatedExtension = ApiRoot.withProjectKeyValue(CommercetoolsTestUtils.getProjectKey())
                    .extensions()
                    .withId(extension.getId())
    ...
    public void deleteByKey() {
        Extension extension = ExtensionFixtures.createExtension();
        Extension deletedExtension = ApiRoot.withProjectKeyValue(CommercetoolsTestUtils.getProjectKey())
                .extensions()
                .withId(extension.getId())
                .delete()
