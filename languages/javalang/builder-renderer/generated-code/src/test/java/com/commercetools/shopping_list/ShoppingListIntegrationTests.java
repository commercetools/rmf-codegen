...
public class ShoppingListIntegrationTests {
    ...
    public void getById() {
        ShoppingListFixtures.withShoppingList(shoppingList -> {
            ShoppingList queriedShoppingList = ApiRoot.withProjectKeyValue(CommercetoolsTestUtils.getProjectKey())
                    .shoppingLists()
    ...
    public void query() {
        ShoppingListFixtures.withShoppingList(shoppingList -> {
            ShoppingListPagedQueryResponse response = ApiRoot.withProjectKeyValue(CommercetoolsTestUtils.getProjectKey())
                    .shoppingLists()
                    .get()
    ...
    public void updateByKey() {
        ShoppingListFixtures.withUpdateableShoppingList(shoppingList -> {
            ...
            ShoppingList updatedShoppingList = ApiRoot.withProjectKeyValue(CommercetoolsTestUtils.getProjectKey())
                    .shoppingLists()
                    .withKey(shoppingList.getKey())
