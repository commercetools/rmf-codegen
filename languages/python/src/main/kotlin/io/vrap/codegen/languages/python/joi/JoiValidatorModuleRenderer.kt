...
import io.vrap.codegen.languages.python.toJoiPackageName
...
class JoiValidatorModuleRenderer @Inject constructor(override val vrapTypeProvider: VrapTypeProvider) : JoiObjectTypeExtensions, PyObjectTypeExtensions, FileProducer {
    @Inject
    @AllAnyTypes
