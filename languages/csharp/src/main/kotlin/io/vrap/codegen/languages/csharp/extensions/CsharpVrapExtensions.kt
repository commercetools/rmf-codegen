...
fun VrapType.simpleName(): String {
    return when (this) {
        ...
        is VrapObjectType -> if(this.simpleClassName == "Date" || this.simpleClassName == "DateTime" || this.simpleClassName == "TimeSpan" || this.simpleClassName == "Object" || this.simpleClassName == "Stream") this.simpleClassName else "I${this.simpleClassName}"
