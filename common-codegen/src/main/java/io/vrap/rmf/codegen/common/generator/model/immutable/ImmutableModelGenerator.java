...
public class ImmutableModelGenerator extends CodeGenerator {
    ...
    protected Stream<AnnotationSpec> getAdditionalTypeAnnotations(final ObjectType object) {
        ...
        final ClassName builderName = ClassName.get(getObjectPackage(getPackagePrefix(), object), object.getName() + "Builder");
    ...
    private MethodSpec mapField(final ObjectType object, Property property) {
    ...
    private MethodSpec mapFieldWithPattern(final ObjectType object, Property property) {
