...
class PhpFileProducer @Inject constructor() : FileProducer {
    ...
    private fun baseCollection(): TemplateFile {
        return TemplateFile(relativePath = "${packagePrefix.toNamespaceDir()}/Base/Collection.php",
                content = """
                        |\<?php
    ...
    private fun baseNullable(): TemplateFile {
        return TemplateFile(relativePath = "${packagePrefix.toNamespaceDir()}/Base/Nullable.php",
                content = """
                    |\<?php
                    |${PhpSubTemplates.generatorInfo}
                    |
    ...
    private fun clientFactory(): TemplateFile {
        return TemplateFile(relativePath = "${packagePrefix.toNamespaceDir()}/Client/ClientFactory.php",
                content = """
                    |<?php
                    |${PhpSubTemplates.generatorInfo}
                    |
                    ...
                    |use ${packagePrefix.toNamespaceName()}\Client\Subscriber\Log\Formatter;
                    |use ${packagePrefix.toNamespaceName()}\Client\Subscriber\Log\LogSubscriber;
