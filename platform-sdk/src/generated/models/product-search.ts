...
import { ErrorObject, ErrorResponse, _ErrorResponse } from 'models/error'
import { ProductProjection } from 'models/product'
import { SearchFieldType, SearchQuery, SearchSortOrder, SearchSorting, _SearchQuery } from 'models/search'
...
export type _ProductSearchFacetExpression = ProductSearchFacetExpression | ProductSearchFacetCountExpression | ProductSearchFacetDistinctExpression | ProductSearchFacetRangesExpression
...
export type ProductSearchFacetScope =
   'all' |
   'query' |
   string;
export type ProductSearchFacetScopeEnum =
   'all' |
   'query' |
   string;
