...
import { BusinessUnitKeyReference, BusinessUnitResourceIdentifier } from 'models/business-unit'
import { CartOrigin, CartReference, CartResourceIdentifier, CustomLineItem, CustomLineItemPriceMode, DirectDiscount, DiscountCodeInfo, DiscountOnTotalPrice, DiscountedLineItemPortionDraft, InventoryMode, ItemShippingDetailsDraft, LineItem, RoundingMode, Shipping, ShippingInfo, ShippingMethodState, ShippingMode, ShippingRateInput, TaxCalculationMode, TaxMode, TaxedPrice, TaxedPriceDraft } from 'models/cart'
...
export type OrderSearchCustomType =
   ...
   'TimeType' |
   string;
export type OrderSearchMatchType =
   'all' |
   'any' |
   string;
...
export type OrderSearchSortMode =
   'avg' |
   'max' |
   'min' |
   'sum' |
   string;
export type OrderSearchSortOrder =
   'asc' |
   'desc' |
   string;
