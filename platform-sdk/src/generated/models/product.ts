...
import { Asset, AssetDraft, AssetSource, BaseResource, CreatedBy, DiscountedPriceDraft, Image, LastModifiedBy, LocalizedString, Price, PriceDraft, Reference, ReferenceTypeId, ResourceIdentifier, ScopedPrice, _BaseResource } from 'models/common'
import { ProductTypeReference, ProductTypeResourceIdentifier } from 'models/product-type'
import { ReviewRatingStatistics } from 'models/review'
import { StateReference, StateResourceIdentifier } from 'models/state'
import { TaxCategoryReference, TaxCategoryResourceIdentifier } from 'models/tax-category'
import { FieldContainer, TypeResourceIdentifier } from 'models/type'
import { WarningObject } from 'models/warning'
...
*	
*/
export type ProductPriceModeEnum =
   'Embedded' |
   'Standalone' |
   string;
