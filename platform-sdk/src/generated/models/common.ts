...
import { AssociateRole, AssociateRoleKeyReference, AssociateRoleReference, AssociateRoleResourceIdentifier } from 'models/associate-role'
import { AttributeGroup, AttributeGroupReference, AttributeGroupResourceIdentifier } from 'models/attribute-group'
import { BusinessUnit, BusinessUnitKeyReference, BusinessUnitReference, BusinessUnitResourceIdentifier, Company, Division } from 'models/business-unit'
import { Cart, CartReference, CartResourceIdentifier, DirectDiscountReference } from 'models/cart'
import { CartDiscount, CartDiscountReference, CartDiscountResourceIdentifier } from 'models/cart-discount'
import { Category, CategoryReference, CategoryResourceIdentifier } from 'models/category'
import { Channel, ChannelReference, ChannelResourceIdentifier } from 'models/channel'
import { CustomObject, CustomObjectReference } from 'models/custom-object'
import { Customer, CustomerEmailTokenReference, CustomerPasswordTokenReference, CustomerReference, CustomerResourceIdentifier } from 'models/customer'
import { CustomerGroup, CustomerGroupReference, CustomerGroupResourceIdentifier } from 'models/customer-group'
import { DiscountCode, DiscountCodeReference, DiscountCodeResourceIdentifier } from 'models/discount-code'
import { Extension } from 'models/extension'
import { InventoryEntry, InventoryEntryReference, InventoryEntryResourceIdentifier } from 'models/inventory'
import { ApprovalFlowApprovedMessage, ApprovalFlowCompletedMessage, ApprovalFlowCreatedMessage, ApprovalFlowRejectedMessage, ApprovalRuleApproversSetMessage, ApprovalRuleCreatedMessage, ApprovalRuleDescriptionSetMessage, ApprovalRuleKeySetMessage, ApprovalRuleNameSetMessage, ApprovalRulePredicateSetMessage, ApprovalRuleRequestersSetMessage, ApprovalRuleStatusSetMessage, AssociateRoleBuyerAssignableChangedMessage, AssociateRoleCreatedMessage, AssociateRoleDeletedMessage, AssociateRoleNameChangedMessage, AssociateRolePermissionAddedMessage, AssociateRolePermissionRemovedMessage, AssociateRolePermissionsSetMessage, BusinessUnitAddressAddedMessage, BusinessUnitAddressChangedMessage, BusinessUnitAddressCustomFieldAddedMessage, BusinessUnitAddressCustomFieldChangedMessage, BusinessUnitAddressCustomFieldRemovedMessage, BusinessUnitAddressCustomTypeRemovedMessage, BusinessUnitAddressCustomTypeSetMessage, BusinessUnitAddressRemovedMessage, BusinessUnitApprovalRuleModeChangedMessage, BusinessUnitAssociateAddedMessage, BusinessUnitAssociateChangedMessage, BusinessUnitAssociateModeChangedMessage, BusinessUnitAssociateRemovedMessage, BusinessUnitAssociatesSetMessage, BusinessUnitBillingAddressAddedMessage, BusinessUnitBillingAddressRemovedMessage, BusinessUnitContactEmailSetMessage, BusinessUnitCreatedMessage, BusinessUnitCustomFieldAddedMessage, BusinessUnitCustomFieldChangedMessage, BusinessUnitCustomFieldRemovedMessage, BusinessUnitCustomTypeRemovedMessage, BusinessUnitCustomTypeSetMessage, BusinessUnitDefaultBillingAddressSetMessage, BusinessUnitDefaultShippingAddressSetMessage, BusinessUnitDeletedMessage, BusinessUnitNameChangedMessage, BusinessUnitParentChangedMessage, BusinessUnitShippingAddressAddedMessage, BusinessUnitShippingAddressRemovedMessage, BusinessUnitStatusChangedMessage, BusinessUnitStoreAddedMessage, BusinessUnitStoreModeChangedMessage, BusinessUnitStoreRemovedMessage, BusinessUnitStoresSetMessage, CartDiscountCreatedMessage, CartDiscountDeletedMessage, CartDiscountStoreAddedMessage, CartDiscountStoreRemovedMessage, CartDiscountStoresSetMessage, CategoryCreatedMessage, CategorySlugChangedMessage, CustomerAddressAddedMessage, CustomerAddressChangedMessage, CustomerAddressCustomFieldAddedMessage, CustomerAddressCustomFieldChangedMessage, CustomerAddressCustomFieldRemovedMessage, CustomerAddressCustomTypeRemovedMessage, CustomerAddressCustomTypeSetMessage, CustomerAddressRemovedMessage, CustomerCompanyNameSetMessage, CustomerCreatedMessage, CustomerCustomFieldAddedMessage, CustomerCustomFieldChangedMessage, CustomerCustomFieldRemovedMessage, CustomerCustomTypeRemovedMessage, CustomerCustomTypeSetMessage, CustomerDateOfBirthSetMessage, CustomerDeletedMessage, CustomerEmailChangedMessage, CustomerEmailTokenCreatedMessage, CustomerEmailVerifiedMessage, CustomerFirstNameSetMessage, CustomerGroupCustomFieldAddedMessage, CustomerGroupCustomFieldChangedMessage, CustomerGroupCustomFieldRemovedMessage, CustomerGroupCustomTypeRemovedMessage, CustomerGroupCustomTypeSetMessage, CustomerGroupSetMessage, CustomerLastNameSetMessage, CustomerPasswordTokenCreatedMessage, CustomerPasswordUpdatedMessage, CustomerTitleSetMessage, DiscountCodeCreatedMessage, DiscountCodeDeletedMessage, DiscountCodeKeySetMessage, InventoryEntryCreatedMessage, InventoryEntryDeletedMessage, InventoryEntryQuantitySetMessage, Message, OrderMessage, OrderPaymentAddedMessage, PaymentCreatedMessage, PaymentInteractionAddedMessage, PaymentStatusInterfaceCodeSetMessage, PaymentStatusStateTransitionMessage, PaymentTransactionAddedMessage, PaymentTransactionStateChangedMessage, ProductAddedToCategoryMessage, ProductCreatedMessage, ProductDeletedMessage, ProductImageAddedMessage, ProductPriceAddedMessage, ProductPriceChangedMessage, ProductPriceCustomFieldAddedMessage, ProductPriceCustomFieldChangedMessage, ProductPriceCustomFieldRemovedMessage, ProductPriceCustomFieldsRemovedMessage, ProductPriceCustomFieldsSetMessage, ProductPriceDiscountsSetMessage, ProductPriceExternalDiscountSetMessage, ProductPriceKeySetMessage, ProductPriceModeSetMessage, ProductPriceRemovedMessage, ProductPricesSetMessage, ProductPublishedMessage, ProductRemovedFromCategoryMessage, ProductRevertedStagedChangesMessage, ProductSelectionCreatedMessage, ProductSelectionDeletedMessage, ProductSelectionProductAddedMessage, ProductSelectionProductExcludedMessage, ProductSelectionProductRemovedMessage, ProductSelectionVariantExclusionChangedMessage, ProductSelectionVariantSelectionChangedMessage, ProductSlugChangedMessage, ProductStateTransitionMessage, ProductTailoringCreatedMessage, ProductTailoringDeletedMessage, ProductTailoringDescriptionSetMessage, ProductTailoringImageAddedMessage, ProductTailoringImagesSetMessage, ProductTailoringNameSetMessage, ProductTailoringPublishedMessage, ProductTailoringSlugSetMessage, ProductTailoringUnpublishedMessage, ProductUnpublishedMessage, ProductVariantAddedMessage, ProductVariantDeletedMessage, ProductVariantTailoringAddedMessage, ProductVariantTailoringRemovedMessage, QuoteCreatedMessage, QuoteCustomerChangedMessage, QuoteDeletedMessage, QuoteRenegotiationRequestedMessage, QuoteRequestCreatedMessage, QuoteRequestCustomerChangedMessage, QuoteRequestDeletedMessage, QuoteRequestStateChangedMessage, QuoteRequestStateTransitionMessage, QuoteStateChangedMessage, QuoteStateTransitionMessage, ReviewCreatedMessage, ReviewRatingSetMessage, ReviewStateTransitionMessage, ShoppingListMessage, StagedQuoteCreatedMessage, StagedQuoteDeletedMessage, StagedQuoteSellerCommentSetMessage, StagedQuoteStateChangedMessage, StagedQuoteStateTransitionMessage, StagedQuoteValidToSetMessage, StandalonePriceActiveChangedMessage, StandalonePriceCreatedMessage, StandalonePriceDeletedMessage, StandalonePriceDiscountSetMessage, StandalonePriceExternalDiscountSetMessage, StandalonePriceKeySetMessage, StandalonePriceStagedChangesAppliedMessage, StandalonePriceStagedChangesRemovedMessage, StandalonePriceTierAddedMessage, StandalonePriceTierRemovedMessage, StandalonePriceTiersSetMessage, StandalonePriceValidFromAndUntilSetMessage, StandalonePriceValidFromSetMessage, StandalonePriceValidUntilSetMessage, StandalonePriceValueChangedMessage, StoreCountriesChangedMessage, StoreCreatedMessage, StoreDeletedMessage, StoreDistributionChannelsChangedMessage, StoreLanguagesChangedMessage, StoreNameSetMessage, StoreProductSelectionsChangedMessage, StoreSupplyChannelsChangedMessage, _OrderMessage, _ShoppingListMessage } from 'models/message'
import { Order, OrderReference, _Order } from 'models/order'
import { OrderEdit, OrderEditReference, OrderEditResourceIdentifier, StagedOrder } from 'models/order-edit'
import { Payment, PaymentReference, PaymentResourceIdentifier } from 'models/payment'
import { Product, ProductProjection, ProductReference, ProductResourceIdentifier } from 'models/product'
import { ProductDiscount, ProductDiscountReference, ProductDiscountResourceIdentifier } from 'models/product-discount'
import { ProductSelection, ProductSelectionReference, ProductSelectionResourceIdentifier } from 'models/product-selection'
import { ProductTailoring, ProductTailoringReference, ProductTailoringResourceIdentifier } from 'models/product-tailoring'
import { ProductType, ProductTypeReference, ProductTypeResourceIdentifier } from 'models/product-type'
import { Quote, QuoteReference, QuoteResourceIdentifier } from 'models/quote'
import { QuoteRequest, QuoteRequestReference, QuoteRequestResourceIdentifier } from 'models/quote-request'
import { Review, ReviewReference, ReviewResourceIdentifier } from 'models/review'
import { ShippingMethod, ShippingMethodReference, ShippingMethodResourceIdentifier } from 'models/shipping-method'
import { ShoppingList, ShoppingListReference, ShoppingListResourceIdentifier } from 'models/shopping-list'
import { StagedQuote, StagedQuoteReference, StagedQuoteResourceIdentifier } from 'models/staged-quote'
import { StandalonePrice, StandalonePriceReference, StandalonePriceResourceIdentifier } from 'models/standalone-price'
import { State, StateReference, StateResourceIdentifier } from 'models/state'
import { Store, StoreKeyReference, StoreReference, StoreResourceIdentifier } from 'models/store'
import { Subscription } from 'models/subscription'
import { TaxCategory, TaxCategoryReference, TaxCategoryResourceIdentifier } from 'models/tax-category'
import { CustomFields, CustomFieldsDraft, Type, TypeReference, TypeResourceIdentifier } from 'models/type'
...
export type _BaseResource = BaseResource | ApprovalFlow | ApprovalRule | AssociateRole | AttributeGroup | BusinessUnit | Cart | CartDiscount | Category | Channel | CustomObject | Customer | CustomerGroup | DiscountCode | Extension | InventoryEntry | Message | _Order | OrderEdit | Payment | Product | ProductDiscount | ProductProjection | ProductSelection | ProductTailoring | ProductType | Quote | QuoteRequest | Review | ShippingMethod | ShoppingList | StagedQuote | StandalonePrice | State | Store | Subscription | TaxCategory | Type | Zone
/**
