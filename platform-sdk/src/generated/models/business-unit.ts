...
import { Address, BaseAddress, BaseResource, CreatedBy, KeyReference, LastModifiedBy, Reference, ReferenceTypeId, ResourceIdentifier, _BaseAddress, _BaseResource } from 'models/common'
...
*	
*/
export type BusinessUnitStoreMode =
   'Explicit' |
   'FromParent' |
   string;
/**
