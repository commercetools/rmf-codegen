            ...
            function createHttpMiddleware(_ref2) {
              ...
              return function (next) {
                return function (request, response) {
                  ...
                  var body = typeof request.body === 'string' || isBuffer(request.body) ? request.body : // NOTE: `stringify` of `null` gives the String('null')
                  JSON.stringify(request.body || undefined);

                  var requestHeader = _objectSpread2({
                    ...
                    fetcher(url, fetchOptions).then(function (res) {
                      if (res.ok) {
                        if (fetchOptions.method === 'HEAD') {
                          next(request, _objectSpread2({}, response, {
                        ...
                        res.json().then(function (result) {
                          var parsedResponse = _objectSpread2({}, response, {
                            body: result,
                            statusCode: res.status
                          });
