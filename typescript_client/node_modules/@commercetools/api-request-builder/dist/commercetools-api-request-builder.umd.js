(function (global, factory) {
  ...
  function setParams(params) {
    ...
    if (hasKey(params, 'applyOrderEditTo')) this.applyOrderEditTo(params.applyOrderEditTo);
  }
  ...
  function createService(definition) {
    ...
    return classify(_objectSpread2({
      type: type,
      features: features$1,
      ...
      if (feature === query) return _objectSpread2({}, acc, {}, query$1, {}, queryPage);
      if (feature === queryOne) return _objectSpread2({}, acc, {}, queryId);
      if (feature === queryLocation) return _objectSpread2({}, acc, {}, queryLocation$1);
      if (feature === queryExpand) return _objectSpread2({}, acc, {}, queryExpand$1);
      if (feature === search) return _objectSpread2({}, acc, {}, querySearch, {}, queryPage, {
        params: getDefaultSearchParams()
      });
      if (feature === suggest) return _objectSpread2({}, acc, {}, querySearch, {}, queryPage, {}, querySuggest);
      if (feature === projection) return _objectSpread2({}, acc, {}, queryProjection);
      return acc;
    }, {}), {
  ...
  function createRequestBuilder() {
    ...
    var allServices = _objectSpread2({}, services, {}, options.customServices);
    ...
    // $FlowFixMe
    function (acc, key) {
      return _objectSpread2({}, acc, _defineProperty({}, key, createService(allServices[key], options.projectKey)));
    }, {});
  }
